<?php
	...
	*/
	...
	// OPTIONAL
	// Leave as is, will be automatically assigned to you when your app is approved.
	$update_link		= "http://www.arrowchat.com/updatecheck.php?id=22";
