	...
	if (var_check('chatroom_settings_submit')) 
	{
		$result = $db->execute("
			...
			SET config_value = CASE 
				...
				WHEN config_name = 'chatroom_message_length' THEN '" . get_var('chatroom_message_length') . "'
			END WHERE config_name IN ('user_chatrooms', 'user_chatrooms_flood', 'user_chatrooms_length', 'chatroom_auto_join', 'chatroom_history_length', 'chatroom_message_length')
		");
		...
		{		
			...
			$result = $db->execute("
				...
				VALUES (
					...
					'" . get_var('add_chatroom_desc') . "', 
					'" . get_var('add_chatroom_welcome_msg') . "', 
					'" . $db->escape_string($icon_filename) . "',
					...
					'" . time() . "',
					'" . get_var('limit_message_num') . "',
					'" . get_var('limit_seconds_num') . "'
				)
			");
		...
		{	
			...
			$result = $db->execute("
				...
				SET name = '" . get_var('edit_chatroom_name') . "', 
					description = '" . get_var('edit_chatroom_desc') . "', 
					welcome_message = '" . get_var('edit_chatroom_welcome_msg') . "', 
					image = '" . get_var('edit_chatroom_img') . "', 
					...
					limit_message_num = '" . get_var('limit_message_num') . "',
					limit_seconds_num = '" . get_var('limit_seconds_num') . "'
