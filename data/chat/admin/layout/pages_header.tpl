...
<head profile="http://gmpg.org/xfn/11"> 
	...
	<title>{$title|default:"Art3araby Administration Panel"}</title> 
...
<div id="wrapper">
	...
	<div id="subnavwrapper">
		<div id="subnav">
			<ul class="menu sblue" id="menu">
			  ...
			  <li><a href="./system.php?do=configsettings">System{if $arrowchat_has_update}{/if}</a>
				<ul>
	...
	<div id="content">
		<div id="leftcontent">
				...
				{/if}
				{if $smarty.get.do eq 'banip' or $smarty.get.do eq 'banusernames' or $smarty.get.do eq 'manageusers' or $smarty.get.do eq 'manageadmins' or $smarty.get.do eq 'logs' or $smarty.get.do eq 'view' or $smarty.get.do eq 'actions'}
				<div class="admin_title_bg"> 
					<ul id ="menu-users"> 
