(function($) {
  ...
  $.fn.inputTags.defaults = {
    ...
    errors: {
      empty: 'Can\'t be null.',
      minLength: 'You can\'t add list item less than %s caractères.',
      maxLength: 'You Can\'t add more than %s character.',
      max: 'You can\'t add more than %s list items.',
      exists: 'Already exists !',
      autocomplete_only: 'You can add only from the exist list.',
      timeout: 8000
    }
  };
